...
tags: ["Seoul", "Line 2", "indoor travel", "Seongsu", "Jamsil", "Samseong", "rainy day"]
publishedAt: "2026-07-06T14:23:00+09:00"
...
<div class="article-summary">
  ...
  <ul>
    <li>Seongsu works best as a 60 to 90 minute opening block for trend shops and one cafe, not as the place where you should spend the entire rainy day.</li>
    <li>Jamsil is the strongest indoor anchor because lunch, restrooms, food, cafes, and one main paid option can all be handled inside the same wider complex.</li>
    <li>Samseong is usually best as a low-pressure closing zone around COEX Mall and Starfield Library rather than a second full restart of the day.</li>
  </ul>
</div>
...
<div class="decision-grid">
  <div>
    ...
    <ul>
      <li>Travelers who want an east-side Seoul day focused on shopping, indoor breaks, and easy subway movement on a rainy forecast</li>
      <li>First-time visitors who want to stay mostly on one subway line and minimize transfers</li>
      <li>People who want to compare the mood of Seongsu with the large indoor complexes of Jamsil and Samseong in one day</li>
    </ul>
  </div>
  <div>
    <h2>When You Should Rework It</h2>
    <ul>
      <li>If the rain is severe enough that even short walks around Seongsu feel wasteful</li>
      <li>If you are traveling with children and want a longer aquarium block than a trend-shopping start</li>
      <li>If your budget only works with free indoor stops and no paid attraction at all</li>
    </ul>
  </div>
</div>
...
<div class="map-route">
  <div class="map-route-head">
    ...
    <a href="https://www.google.com/maps/dir/?api=1&origin=%EC%84%B1%EC%88%98%EC%97%AD&destination=%EC%8A%A4%ED%83%80%ED%95%84%EB%93%9C%20%EB%9D%BC%EC%9D%B4%EB%B8%8C%EB%9F%AC%EB%A6%AC&waypoints=%EB%A1%AF%EB%8D%B0%EC%9B%94%EB%93%9C%EB%AA%B0&travelmode=transit" target="_blank" rel="noopener noreferrer">Open full route</a>
  </div>
  <ol class="map-stop-list">
    <li>
      <span>1</span>
      <strong>Seongsu Station and Yeonmujang-gil</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EC%84%B1%EC%88%98%EC%97%AD" target="_blank" rel="noopener noreferrer">Open in Maps</a>
    </li>
    <li>
      <span>2</span>
      <strong>Lotte World Mall in Jamsil</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EB%A1%AF%EB%8D%B0%EC%9B%94%EB%93%9C%EB%AA%B0" target="_blank" rel="noopener noreferrer">Open in Maps</a>
    </li>
    <li>
      <span>3</span>
      <strong>Seoul Sky or an aquarium option</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EC%84%9C%EC%9A%B8%EC%8A%A4%EC%B9%B4%EC%9D%B4" target="_blank" rel="noopener noreferrer">Open in Maps</a>
    </li>
    <li>
      <span>4</span>
      <strong>Starfield Library and COEX Mall in Samseong</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EC%8A%A4%ED%83%80%ED%95%84%EB%93%9C%20%EB%9D%BC%EC%9D%B4%EB%B8%8C%EB%9F%AC%EB%A6%AC" target="_blank" rel="noopener noreferrer">Open in Maps</a>
    </li>
  </ol>
</div>
...
<section class="planning-table">
  ...
  <div>
    <span>10:00</span>
    <strong>Seongsu Station and Yeonmujang-gil</strong>
    <p>Keep the start selective: one or two indoor concept stores and one cafe are enough before the route begins to drag.</p>
  </div>
  <div>
    <span>12:10</span>
    <strong>Lotte World Mall</strong>
    <p>Move directly from Seongsu on Line 2, eat lunch first, and let Jamsil absorb the strongest rain period.</p>
  </div>
  <div>
    <span>14:00</span>
    <strong>Seoul Sky or aquarium block</strong>
    <p>Choose only one main paid attraction if you still want enough time and energy for Samseong later.</p>
  </div>
  <div>
    <span>17:00</span>
    <strong>COEX Mall and Starfield Library</strong>
    <p>If Jamsil already used most of your time or budget, finish with free indoor rest and dinner rather than another large paid activity.</p>
  </div>
</section>
...
<section class="planning-table">
  <h2>How To Choose The Jamsil Core Stop</h2>
  <div class="planning-table-head">
    <span>Condition</span>
  ...
  <div>
    <span>The rain eases and the skyline opens</span>
    <strong>Seoul Sky</strong>
    <p>The view becomes the memory, and you do not need a very long stay to justify the stop.</p>
  </div>
  <div>
    <span>Children, heavy rain, or heat stress</span>
    <strong>Aquarium block</strong>
    <p>It keeps the day protected from the weather and produces a more stable indoor stay.</p>
  </div>
  <div>
    <span>Budget-first planning</span>
    <strong>Free mall-only route</strong>
    <p>Lunch, bookstores, cafes, and rest are enough to fill two or three hours without ticket costs.</p>
  </div>
  <div>
    <span>You still want Samseong to matter later</span>
    <strong>One paid attraction only</strong>
    <p>Trying to do everything in Jamsil leaves Samseong feeling forced and tired.</p>
  </div>
</section>
...
<section class="planning-table compact">
  ...
  <div><span>Local transport</span><strong>KRW 5,000-15,000</strong><p>A Climate Card day pass or a regular transit card both work; short taxi use pushes the total upward quickly.</p></div>
  <div><span>Seongsu cafe and snacks</span><strong>KRW 8,000-20,000</strong><p>If the line is long, skip it and let Jamsil handle the bigger food block instead.</p></div>
  <div><span>Jamsil paid attraction</span><strong>KRW 0-33,000+</strong><p>Staying mall-only can cost nothing; Seoul Sky’s adult general ticket is KRW 33,000.</p></div>
  <div><span>Dinner and another cafe</span><strong>KRW 20,000-45,000</strong><p>This assumes one proper meal in Jamsil or Samseong plus one more break.</p></div>
...
1. If rain is already severe in the morning, reduce Seongsu to about 45 minutes.
2. In Jamsil, keep only one main paid stop.
3. In Samseong, keep Starfield Library and dinner, then remove extra paid attractions.
