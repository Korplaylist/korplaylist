...
tags: ["ソウル", "2号線", "屋内旅行", "聖水", "蚕室", "三成", "雨の日"]
publishedAt: "2026-07-06T21:17:00+09:00"
updatedAt: "2026-07-06T21:17:00+09:00"
...
<div class="article-summary">
  <strong>要点</strong>
  <ul>
    <li>聖水は60〜90分ほどで感度の高い店とカフェを短く見る出発区間として扱う方が、雨の日は満足度が安定します。</li>
    <li>蚕室は昼食、休憩、トイレ、カフェ、有料屋内の選択肢まで同じエリアで処理しやすく、強い雨の時間帯を受け止める軸になります。</li>
    <li>三成はコエックスモールとスターフィールド・ライブラリーを使って、買い足しよりも体力を戻しながら締める区間にする方が実用的です。</li>
  </ul>
</div>
...
<div class="decision-grid">
  <div>
    <h2>このルートが合う人</h2>
    <ul>
      <li>雨予報でもソウル東側エリアの雰囲気、買い物、屋内休憩を1日でまとめたい人</li>
      <li>乗り換えを減らし、できるだけ2号線一本で動きたい初訪問者</li>
      <li>聖水のトレンド感と蚕室・三成の大型屋内複合空間を同日に比べてみたい人</li>
    </ul>
  </div>
  <div>
    <h2>組み替えた方がよい場合</h2>
    <ul>
      <li>豪雨で、聖水の短い地上移動すら減らしたい場合</li>
      <li>子ども連れで、聖水のショップ巡りより水族館滞在を優先したい場合</li>
      <li>有料施設を入れず、無料の屋内動線だけで組みたい場合</li>
    </ul>
  </div>
</div>
...
<div class="map-route">
  <div class="map-route-head">
    ...
    <a href="https://www.google.com/maps/dir/?api=1&origin=%EC%84%B1%EC%88%98%EC%97%AD&destination=%EC%8A%A4%ED%83%80%ED%95%84%EB%93%9C%20%EB%9D%BC%EC%9D%B4%EB%B8%8C%EB%9F%AC%EB%A6%AC&waypoints=%EB%A1%AF%EB%8D%B0%EC%9B%94%EB%93%9C%EB%AA%B0&travelmode=transit" target="_blank" rel="noopener noreferrer">全体ルートを開く</a>
  </div>
  <ol class="map-stop-list">
    <li>
      <span>1</span>
      <strong>聖水駅・延武場キル</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EC%84%B1%EC%88%98%EC%97%AD" target="_blank" rel="noopener noreferrer">地図で見る</a>
    </li>
    <li>
      <span>2</span>
      <strong>蚕室 ロッテワールドモール</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EB%A1%AF%EB%8D%B0%EC%9B%94%EB%93%9C%EB%AA%B0" target="_blank" rel="noopener noreferrer">地図で見る</a>
    </li>
    <li>
      <span>3</span>
      <strong>ソウルスカイ または水族館</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EC%84%9C%EC%9A%B8%EC%8A%A4%EC%B9%B4%EC%9D%B4" target="_blank" rel="noopener noreferrer">地図で見る</a>
    </li>
    <li>
      <span>4</span>
      <strong>三成 スターフィールド・ライブラリー・コエックスモール</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EC%8A%A4%ED%83%80%ED%95%84%EB%93%9C%20%EB%9D%BC%EC%9D%B4%EB%B8%8C%EB%9F%AC%EB%A6%AC" target="_blank" rel="noopener noreferrer">地図で見る</a>
    </li>
  </ol>
</div>
...
<section class="planning-table">
  ...
  <div>
    <span>10:00</span>
    <strong>聖水駅・延武場キル</strong>
    <p>屋内ショップ1〜2か所とカフェ1回で十分です。ここを長くしすぎると後半が崩れます。</p>
  </div>
  <div>
    <span>12:10</span>
    <strong>ロッテワールドモール</strong>
    <p>聖水から2号線で移動したら先に昼食を済ませ、いちばん強い雨の時間帯を蚕室で受ける方が安定します。</p>
  </div>
  <div>
    <span>14:00</span>
    <strong>ソウルスカイ または水族館</strong>
    <p>この日の主役になる有料屋内は一つに絞る方が、三成まで含めた全体の完成度が高くなります。</p>
  </div>
  <div>
    <span>17:00</span>
    <strong>コエックスモール</strong>
    <p>蚕室で十分に時間と予算を使ったなら、三成は無料休憩と夕食中心で締める方が無理がありません。</p>
  </div>
</section>
...
<section class="planning-table">
  ...
  <div>
    <span>雨が弱まり視界が出る</span>
    <strong>ソウルスカイ</strong>
    <p>景色が価値を持ち、短めの滞在でも満足度を得やすいです。</p>
  </div>
  <div>
    <span>子ども連れ・強い雨・暑さ</span>
    <strong>水族館</strong>
    <p>天気のブレを受けにくく、室内滞在が安定します。</p>
  </div>
  <div>
    <span>予算を抑えたい</span>
    <strong>モール中心の無料運用</strong>
    <p>昼食、書店、カフェ、休憩だけでも2〜3時間は無理なく使えます。</p>
  </div>
  <div>
    <span>三成もきちんと残したい</span>
    <strong>有料は1つだけ</strong>
    <p>蚕室で詰め込みすぎると後半がただの移動になります。</p>
  </div>
</section>
...
<section class="planning-table compact">
  ...
  <div><span>市内交通</span><strong>5,000〜15,000ウォン</strong><p>気候同行カード1日券か通常交通カードを想定し、短いタクシーを入れると上がります。</p></div>
  <div><span>聖水のカフェ・軽食</span><strong>8,000〜20,000ウォン</strong><p>待ち時間が長ければ無理せず、食事の主軸は蚕室に移す方が得です。</p></div>
  <div><span>蚕室の有料入場</span><strong>0〜33,000ウォン以上</strong><p>モール中心なら0円、ソウルスカイは大人一般券33,000ウォンです。</p></div>
  <div><span>夕食・カフェ</span><strong>20,000〜45,000ウォン</strong><p>蚕室か三成でしっかり1食、さらに1回休憩を入れる想定です。</p></div>
...
1. 朝から雨が強ければ、聖水は45分前後まで縮める。
2. 蚕室では有料の主役を一つだけ残す。
3. 三成ではスターフィールド・ライブラリーと夕食だけ残す。
