...
<section class="article-note adsense-repair-note">
  ...
  <p>부산역에서 출발하기 전에 짐을 다시 찾으러 역으로 돌아올지부터 정하세요. 같은 날 기차를 타는 일정이라면 짐 회수와 승강장 이동 시간을 남겨야 하고, 숙소로 바로 이동한다면 가방을 어디에서 받을지가 마지막 관광지 선택에 영향을 줍니다.</p>
  ...
  <p>표의 출발 시각보다 늦게 부산역을 나섰다면 그만큼 전체 일정을 뒤로 미루기보다 감천 산책이나 시장 체류 중 하나를 줄이세요. 기차 출발 또는 숙소 도착에 필요한 시간을 먼저 남기면 반나절 동안 실제로 볼 수 있는 범위가 정해집니다.</p>
</section>
...
<section class="article-note adsense-repair-note-2">
  ...
  <p>남포동에서 일정을 끝낼 장소와 그곳에서 짐 보관소 또는 숙소까지 가는 경로를 함께 저장해 두세요. 식당 대기가 길어졌을 때는 BIFF광장 쇼핑 시간을 줄이는 식으로 조정하고, 짐을 찾기 위한 복귀 시간까지 식사 대기에 쓰지는 마세요.</p>
</section>

<section class="article-note adsense-repair-note-3">
  <h2>당일 아침에 다시 확인할 것</h2>
  <p>도착 당일에는 이용할 보관소의 접수·회수 가능 시간과 감천 이동편을 확인하세요. 비가 강하면 야외 골목과 시장 사이 이동도 젖는 구간이므로, 남포동의 영업 중인 식당 한 곳을 중심으로 산책을 줄일 준비를 해두는 편이 좋습니다.</p>
</section>
