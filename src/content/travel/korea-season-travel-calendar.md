...
서울 봄꽃·강릉 바다·경주 가을·제주 겨울은 계절별 여행 후보를 비교하기 위한 예시입니다. 아래 지도와 시간표를 하루에 모두 이동하는 계획으로 쓰지 말고, 실제 떠날 계절과 한 지역을 고른 뒤 그 지역의 교통과 운영 공지를 확인하세요.
...
<section class="planning-table compact">
  ...
  <div><span>입장·체험</span><strong>물관을 넣는지에 따라 달라집니다.</p></div>
