---
title: "Jeonju Hanok Village Day Trip: Gyeonggijeon, Nambu Market and One-Day Route"
description: "A Jeonju day itinerary covering Hanok Village, Gyeonggijeon, Nambu Market, food breaks, walking order, and return transport timing."
...
A Jeonju day itinerary covering Hanok Village, Gyeonggijeon, Nambu Market, food breaks, walking order, and return transport timing.

From Jeonju Station, decide how much time belongs to Gyeonggijeon and how much to the Hanok Village streets before continuing to Nambu Market. Keep the market meal and the station transfer visible in the plan rather than using all available time on the first walk.
...
<div class="decision-grid">
  <div>
    ...
    <ul>
      <li>First-time visitors who want a clear route from Jeonju Station to Nambu Market without overplanning every minute.</li>
...
<div class="map-route">
  <div class="map-route-head">
    ...
    <a href="https://www.google.com/maps/dir/?api=1&origin=%EC%A0%84%EC%A3%BC%EC%97%AD&destination=%EC%A0%84%EC%A3%BC%EB%82%A8%EB%B6%80%EC%8B%9C%EC%9E%A5&waypoints=%EC%A0%84%EC%A3%BC%ED%95%9C%EC%98%A5%EB%A7%88%EC%9D%84%7C%EA%B2%BD%EA%B8%B0%EC%A0%84&travelmode=transit" target="_blank" rel="noopener noreferrer">Open full route</a>
  </div>
  <ol class="map-stop-list">
    <li>
      <span>1</span>
      <strong>Jeonju Station</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EC%A0%84%EC%A3%BC%EC%97%AD" target="_blank" rel="noopener noreferrer">Open in Maps</a>
    </li>
    <li>
      <span>2</span>
    ...
    <li>
      <span>3</span>
      <strong>Gyeonggijeon Shrine</strong>
      <a href="https://www.google.com/maps/search/?api=1&query=%EA%B2%BD%EA%B8%B0%EC%A0%84" target="_blank" rel="noopener noreferrer">Open in Maps</a>
    </li>
    <li>
      <span>4</span>
...
<figure class="content-photo">
  <picture>
    ...
    <img src="/images/generated/unique/jeonju-hanok-food-alley-generated-jeonju-hanok-village-day-trip-1.jpg" alt="Jeonju Hanok Village Day Trip: Gyeonggijeon, Nambu Market and One-Day Route travel guide image" width="1200" height="800" loading="lazy" decoding="async" sizes="(max-width: 860px) calc(100vw - 36px), 792px" />
  </picture>
...
The route from Jeonju Station to Nambu Market may look simple on a map, but transfers, bus intervals, luggage, and the final return can change the real difficulty.
...
For food, plan a longer meal near Nambu Market. Do not build the whole day around one popular restaurant. Save two or three options in the same area. If the queue is long, recover with a cafe or market snack first and move the main meal to the next zone.
...
The biggest mistake is treating Jeonju Station, Jeonju Hanok Village, Gyeonggijeon Shrine, and Nambu Market as equally important.
